...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            ...
            <small><b>การวิเคราะห์รูปแบบการจัดคนเข้าห้องพักในหอพักที่ส่งผลต่อการเสริมศักยภาพของนักศีกษา</b></small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                        	<a href=" site_url("dorm/chart1") "></a>
                            <button class="btn btn-block bg-pink waves-effect" type="submit" >ตกลง</button>
                        </div>
                    </div>
